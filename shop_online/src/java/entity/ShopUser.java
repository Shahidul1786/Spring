package entity;
// Generated Apr 17, 2019 8:31:39 PM by Hibernate Tools 4.3.1
...
public class ShopUser  implements java.io.Serializable {
    ...
    public ShopUser(UserRole userRole, String userName, String password, String email, Date regDate, String cotactNo) {
    ...
    public ShopUser(UserRole userRole, String userName, String password, String email, Date regDate, String cotactNo, Set proOrders) {
       this.userRole = userRole;
       this.userName = userName;
       this.password = password;
       this.email = email;
